...
"WeakMap"in this||function(g){function a(){function f(b){if(b!==d(b))throw new TypeError("not a non-null object");c=m.call(e,b);return-1<c}var e=[],b=[];return n(h,{"delete":{value:function(l){f(l)&&(e.splice(c,1),b.splice(c,1));return-1<c}},get:{value:function(e,a){return f(e)?b[c]:a}},has:{value:f},set:{value:function(a,d){f(a)?b[c]=d:b[e.push(a)-1]=d}}})}function k(){}var d=g.Object,h=a.prototype,n=d.create||function(c,a){var b=new k;b["delete"]=a["delete"].value;b.get=a.get.value;b.has=a.has.value;
    b.set=a.set.value;return b},m=[].indexOf||function(a){for(c=this.length;c--&&this[c]!==a;);return c},c;a.prototype=k.prototype=h=a();"defineProperty"in d?d.defineProperty(g,"WeakMap",{value:a}):g.WeakMap=a}(this);
